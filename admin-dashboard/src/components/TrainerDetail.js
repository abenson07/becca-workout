    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
                  ...
                  <div className="col-span-3">
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">{trainer.id}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700">Specialties</label>
                        <p className="mt-1 text-sm text-gray-900">{trainer.specialties || 'No specialties listed'}</p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-lg font-medium text-gray-900">Created Workouts</h3>
            </div>
            <div className="p-6">
              <p className="text-gray-500">No workouts created</p>
            </div>
          </div>
        </div>
      </div>
