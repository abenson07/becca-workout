...
import { createWorkout } from '../../utils/supabaseWorkouts';
  ...
  if (entityType === 'workout') {
    ...
    return (
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="workout-creation-modal-title"
      >
        <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <h2 id="workout-creation-modal-title" className="text-xl font-semibold text-gray-900">
              Create New Workout
            </h2>
            <button
              onClick={onClose}
